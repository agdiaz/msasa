...
class SingleBlosum(SequencesComparer):
    ...
    def score(self, residues_tuple):
        ...
        return char_rblosum69p13.get((residue_a, residue_b), char_blosum62.get((residue_b, residue_a), -5))

        # if residue_a == B_GAP and residue_b == B_GAP:
        #     return -10
        # elif B_GAP in residues_tuple:
        #     return -7
        # else:
