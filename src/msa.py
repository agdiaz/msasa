...
if __name__ == "__main__":
	...
	parser.add_argument('--comparer', dest='sequences_comparer', required=True, type=str, choices=['single_ms', 'single_blosum', 'single_matching'], help='method to compare two sequences')
	parser.add_argument('--inner-loop', dest='inner_loop', required=False, action='store_true')
	...
	parser.add_argument('--debug', dest='is_debugging', required=False, action='store_true', help='Print out debugging data during the execution of the algorithm')
